...
- [x] Nombre del proyecto y petición de repositorio GIT/BBDD — ver `Estado_del_proyecto.md` §1.2/§1.3.
- [x] Repositorio GIT y BBDD creados — confirmado por Soporte Datacenter (Altia), 10/09/2026. Ver `Estado_del_proyecto.md` §1.3.
