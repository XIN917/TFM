...
- [ ] **Pendiente de respuesta**: Grupos de Acceso de la BBDD (`GGBD_<Servidor>_HV_OrganismosPublicos_(r, r/w)`) — falta que nos confirmen el nombre del servidor para poder completar la petición.
